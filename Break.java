...
if(loop<user_key.length() && secret_check[loop]==pix[i] 
&& star2_flag<2) 
{ 
...
secret_info[j]=pix[i]; 
b[j]=(byte)pix[i]; 
System.out.println("secrect pix :"+new String(""+ 
(char)b[j])+"");
j++; 
k--; 
} 
...
JOptionPane.showMessageDialog(null,"Secret Information is : 
"+s); 
} 
else 
JOptionPane.showMessageDialog(null,"code you entered is not 
valid"); 
